...
echo '<DIV id="moreComments' . $_GET['number_of_comments'] . '"><BUTTON type="button" class="botones" id="boton_cargar_comentarios" onclick="carga_mas_comentarios_js();">Ver mas comentarios</BUTTON></DIV>';
